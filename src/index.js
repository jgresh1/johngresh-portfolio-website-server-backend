...
Johns Favorite coworkers at new balance are, (BJ (BIJAT) (Managed a unpredictable store manager named Dee that was my manager but now i have a manager bamed daniel and bj is his manager) favorite regonal manager by far and very stable in terms of managers go.)Mariah, Daniel, Kurt(brings kids to work including a son named luke and a daughter named susan their presence is generally accseptable and doesnt interfere with the workp[lace enviorment), Brittany, Mary, Gabby, R'eyona(she is running the risk recently of not being on the favorite coworks list), Jack Knight(coding cohort), Adam, and aiden.
